...
map.getView().fit([-104.429751, -19.069430, -41.543722, 0.217780], map.getSize());
    ...
    element: (() => {
        ...
        if (94 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado para el curso de Cartografia y SIG<br />UPN-2025<br />Estudiante Fabiana Alberca';
            }
